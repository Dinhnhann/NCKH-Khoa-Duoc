...
namespace _2021NCKH.Areas.VuonThucVat.Controllers
{
    public class NganhThucVatsController : Controller
    {
        ...
        // GET: VuonThucVat/NganhThucVats
        public ActionResult Index()
        {
            return View(db.NganhThucVats.ToList());
        }

        // GET: VuonThucVat/NganhThucVats/Details/5
        ...
        // GET: VuonThucVat/NganhThucVats/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: VuonThucVat/NganhThucVats/Create
        ...
        // GET: VuonThucVat/NganhThucVats/Edit/5
        ...
        // POST: VuonThucVat/NganhThucVats/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: VuonThucVat/NganhThucVats/Delete/5
        ...
        // POST: VuonThucVat/NganhThucVats/Delete/5
